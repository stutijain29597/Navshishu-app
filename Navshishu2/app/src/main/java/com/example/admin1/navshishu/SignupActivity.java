      ...
      address = (EditText) findViewById(R.id.a);
        ...
        btnSignUp.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                {
                    branch.setError("Date id required");
                    return;
                }
                ...
                if(addres.length()==0)
                {
                    address.setError("Address no. id required");
                    return;
                }
                        ...
                        .addOnCompleteListener(SignupActivity.this, new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if (!task.isSuccessful()) {
                                    ...
                                    user user1=new user(getname,getbranch,addres,"https://firebasestorage.googleapis.com/v0/b/navshishu.appspot.com/o/profile.png?alt=media&token=82909e71-db4b-4d72-bd6e-a4351289f0e4");
